...
Or via an interactive console :
  ...
  $ svc-api-gateway console --address localhost:42000
...
func init() {
	...
	RootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.svc-api-gateway.yaml)")
...
func initConfig() {
	...
	viper.SetConfigName(".svc-api-gateway") // name of config file (without extension)
